  ...
  return (
    <div className='flex gap-96 '>
      <div className='p-24'>
        ...
        <p className='w-96 mt-7 mb-7 '>Explore thousands of job opportunities with all the information you need. Its your future. Come find it. Manage all your job application from start to finish.</p>
